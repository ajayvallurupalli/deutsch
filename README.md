 # Python App for Practicing German
...
# TODO
## EDIT DECKS - 
- [X] Option menu when clicking on a word
...
##PLAY
- [X] Select a Deck 
- [X] Select Eng -> Deu or Deu -> Eng
- [X] Show number of cards selecred
- [X] It shows one side of the flashcard, you have to type the other
- [X] if you fail, it shows the correct and allows override
  - [X] Records data of hits misses and times played 
